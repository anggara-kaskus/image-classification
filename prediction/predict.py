...
from os.path import isfile, join, exists, isdir, abspath, dirname
...
model_directory=join(dirname(script_directory), 'models')
...
def main(args=None):
    ...
    submain.add_argument('--saved_model_path', dest='saved_model_path', type=str, required=False, 
                            help='The model to load', default=model_directory)
